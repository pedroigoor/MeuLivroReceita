...
namespace MyRecipeBook.Domain.Services.OpenAI {
    ...
    public class ResourceOpenAI {
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a You are a chef who knows many tasty recipes. When the user gives you a list of ingredients separated by &apos;;&apos;, you reply with just one recipe that is easy to create with the ingredients given..
        /// </summary>
